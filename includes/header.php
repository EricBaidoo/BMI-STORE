...
<head>
  ...
  if (file_exists($possiblePath)) {
    echo "<link href=\"assets/css/{$pageCss}\" rel=\"stylesheet\">\n";
  }
  ?>
</head>
<body>
<header class="site-header" style="margin-bottom:0;">
    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="index.php">
        <div class="brand-mark me-2" aria-hidden="true">
          ...
          if ($logoPath): ?>
            <img src="<?= htmlspecialchars($logoPath) ?>" alt="<?= htmlspecialchars(site_name()) ?> logo" class="brand-logo">
          <?php else: ?>
            <!-- fallback inline SVG -->
  ...
  <ul class="navbar-nav align-items-lg-center navbar-nav-centered">
          <li class="nav-item me-3"><a class="nav-link <?= $currentScript === 'index.php' ? 'active' : '' ?>" href="index.php">Home</a></li>
          <li class="nav-item me-3"><a class="nav-link <?= $currentScript === 'books.php' ? 'active' : '' ?>" href="books.php">Books</a></li>
          <li class="nav-item me-3"><a class="nav-link <?= $currentScript === 'contact.php' ? 'active' : '' ?>" href="contact.php">Contact</a></li>
        ...
        <a class="btn cart-btn position-relative" href="cart.php" aria-label="Cart">
      ...
      <div class="d-lg-none mt-2 w-100">
        <form class="d-flex" role="search" action="books.php" method="get">
