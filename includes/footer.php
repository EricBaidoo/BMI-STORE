    ...
    <div class="row gy-4">
      <div class="col-lg-4 col-md-6">
        <div class="d-flex align-items-center mb-2">
          <?php if (file_exists(__DIR__ . '/../assets/images/logo.svg')): ?>
            <img src="<?= htmlspecialchars($assetPrefix ?? '') ?>/assets/images/logo.svg" alt="<?= htmlspecialchars(site_name()) ?>" class="footer-logo me-2">
          <?php elseif (file_exists(__DIR__ . '/../assets/img/author.svg')): ?>
            <img src="<?= htmlspecialchars($assetPrefix ?? '') ?>/assets/img/author.svg" alt="<?= htmlspecialchars(site_name()) ?>" class="footer-logo me-2">
          <?php endif; ?>
          <div>
      ...
      <nav class="col-lg-2 col-md-6" aria-label="Shop links">
        ...
        <ul class="list-unstyled mb-0">
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/books.php">Books</a></li>
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/index.php">Home</a></li>
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/contact.php">Contact</a></li>
        </ul>
      </nav>
      ...
      <nav class="col-lg-2 col-md-6" aria-label="Support links">
        ...
        <ul class="list-unstyled mb-0">
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/privacy.php">Privacy</a></li>
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/terms.php">Terms</a></li>
          <li><a class="footer-link" href="<?= htmlspecialchars($assetPrefix ?? '') ?>/faq.php">FAQ</a></li>
        </ul>
      </nav>

      <div class="col-lg-4 col-md-6">
        <h6 class="text-white">Newsletter</h6>
        <form action="<?= htmlspecialchars($assetPrefix ?? '') ?>/subscribe.php" method="post" class="d-flex footer-subscribe align-items-start" novalidate>
